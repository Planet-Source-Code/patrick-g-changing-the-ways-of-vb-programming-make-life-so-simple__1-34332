...
'This is such a simple, simple way to play mp3's.. text1.item(9) = the filename
    dll.PlayMP3 Text1.Item(9)
End Sub

Private Sub Command14_Click()
'This is yet another simple, simple way to play movies with just a small little command
    dll.PlayMovie Text1.Item(10)
End Sub
...
'Load saved information from registry into mp3 and movie text boxes
Text1.Item(10) = dll.GetRegistry("Folder", "Movie", "File")
Text1.Item(9) = dll.GetRegistry("Folder", "Mp3", "File")
...
'This is how simple you can get an exit message
    dll.DatabaseClose
    dll.SaveRegistry "Folder", "Movie", "File", Text1.Item(10)
    dll.SaveRegistry "Folder", "Mp3", "File", Text1.Item(9)
